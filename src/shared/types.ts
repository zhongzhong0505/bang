...
export const AI_PROVIDER_PRESETS: AIProviderPreset[] = [
  ...
  },
  {
    ...
    name: '腾讯 TokenHub (MaaS)',
    label: 'TokenHub',
    baseUrl: 'https://api.hunyuan.cloud.tencent.com/v1',
    models: [
      { value: 'hunyuan-turbos-latest', label: '混元 Turbos Latest', desc: '最新极速（推荐）' },
      { value: 'hunyuan-t1', label: '混元 T1', desc: '深度推理' },
      { value: 'hunyuan-t1-vision', label: '混元 T1 Vision', desc: '推理+视觉' },
      { value: 'hunyuan-pro', label: '混元 Pro', desc: '高性能模型' },
      { value: 'hunyuan-standard', label: '混元 Standard', desc: '标准模型' },
      { value: 'hunyuan-lite', label: '混元 Lite', desc: '轻量快速' },
      { value: 'hunyuan-vision', label: '混元 Vision', desc: '多模态视觉' },
      { value: 'hunyuan-functioncall', label: '混元 FunctionCall', desc: '函数调用' },
      { value: 'deepseek-v4-pro', label: 'DeepSeek V4 Pro', desc: 'DeepSeek 最新旗舰' },
      { value: 'deepseek-v4-flash', label: 'DeepSeek V4 Flash', desc: 'DeepSeek 极速' },
      { value: 'deepseek-r1', label: 'DeepSeek R1', desc: '深度推理' },
      { value: 'deepseek-v3', label: 'DeepSeek V3', desc: '通用对话' },
      { value: 'glm-5', label: 'GLM-5', desc: '智谱最新旗舰' },
      { value: 'glm-4.7', label: 'GLM-4.7', desc: '智谱高性能' },
      { value: 'qwen-max', label: 'Qwen Max', desc: '通义千问旗舰' },
      { value: 'qwen-plus', label: 'Qwen Plus', desc: '通义千问进阶' },
      { value: 'yi-lightning', label: 'Yi Lightning', desc: '零一万物' },
      { value: 'llama-4-maverick-17b', label: 'Llama 4 Maverick', desc: 'Meta 最新' },
      { value: 'mistral-large-2412', label: 'Mistral Large', desc: 'Mistral 旗舰' },
    ],
    authType: 'bearer',
  },
];
